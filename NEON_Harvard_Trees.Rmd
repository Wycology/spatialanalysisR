...
I then generated vegetation life-forms classes for the site based on quartiles of their heights as Bare, Grass, Shrubs, and Trees. Then I used `mutate` to add the life-form classes to the dataframe using `case_when` within `mutate`.</font>
