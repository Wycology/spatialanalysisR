...
This is returning a quite helpful information. We can also have the information within the text as `r st_crs(honeybee)`. I still can't imagine how the output will look like in the text. Let us see by knitting the markdown. Everything thrown to text :).
