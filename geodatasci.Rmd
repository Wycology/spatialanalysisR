...
### Spatial joins
It is quite unfortunate that I still cannot tell how spatial join works. I need to study the output deeply.
This is calling for joining the two datasets into one. The type of join to use here is left join which is the default. Loosely speaking, I will say 
