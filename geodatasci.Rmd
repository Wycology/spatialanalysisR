...
The data I used in this work can be [directly downloaded](https://opendata.arcgis.com/datasets/f99ce43936d74f718e92a37a560ad875_0.zip), extracted from a , and saved in a sub-folder, here called *shp*, the same directory as where the .Rmd file folder is located.
